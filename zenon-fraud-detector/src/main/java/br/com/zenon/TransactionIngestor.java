...
public class TransactionIngestor {
    ...
    public List<Transaction> getTransactionList(String nomeArquivo) throws Exception {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("../zenon-fraud-detector/data/" + nomeArquivo))) {
            ...
            int linesCount = 0;
            String line;
            while ((line = br.readLine()) != null && linesCount < 100000) {
    ...
    public Map<String, Transaction> getTransactionMap(String nomeArquivo) throws Exception {
        Map<String, Transaction> transactionMap = new java.util.HashMap<>();
        try (BufferedReader br = new BufferedReader(new FileReader("../zenon-fraud-detector/data/" + nomeArquivo))) {
            br.readLine();
            int linesCount = 0;
            String line;
